...
export const previewPlaceholder =
  'w-16 h-16 rounded border bg-gray-100 flex items-center justify-center text-gray-400 text-xs';
...
export const removeButton =
  'absolute top-1 right-1 bg-black bg-opacity-60 text-white text-xs rounded-full p-1 hidden group-hover:block';
