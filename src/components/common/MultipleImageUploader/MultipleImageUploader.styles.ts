...
export const removeButton = "absolute top-1 right-1 bg-black bg-opacity-50 text-white rounded-full p-0.5 hover:bg-black transition-colors disabled:cursor-not-allowed";
