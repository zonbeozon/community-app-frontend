...
const ChannelForm = ({
  ...
  const handleImageUploadSuccess = useCallback((imageId: number | null) => {
      ...
      <div className={S.section}>
        ...
        {!isEdit && (
          <div className={S.inputGroupMargin}>
            ...
            >
              <Label htmlFor="type-blog" className={S.radioLabel}>
                <RadioGroupItem value="BLOG" id="type-blog" />
                블로그
              </Label>
              <Label htmlFor="type-groupchat" className={S.radioLabel}>
        ...
        <div className={S.inputGroupMargin}>
          <Label htmlFor="channelTitle" className={S.labelMargin}>채널 이름</Label>
          <Input
            id="channelTitle"
        ...
        <div className={S.inputGroupMargin}>
          <Label htmlFor="channelDescription" className={S.labelMargin}>채널 설명</Label>
          <AutosizeTextarea
