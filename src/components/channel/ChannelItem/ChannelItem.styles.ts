...
export const latestPost = "truncate text-xs text-gray-500 dark:text-gray-400 mt-0.5";

export const dropdownContainer = "absolute right-1 top-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-opacity";
